      ...
      <div class="seances-container">
        ...
        <div class="detail-seances">
          <div class="detail-salles-dates-container">
            <div v-for="(seance, index) in seance.dates.sort((a, b) => a.jourChiffre - b.jourChiffre)" :key="index"
          ...
          <div class="movie-container">
            <div class="list-salles" v-if="SelectedIndex !== null">
              <div v-for="(salles, sallesIndex) in seance.dates[SelectedIndex].films" class="seances-cinema-details"
