            ...
            <div class = "seances-container">  
                ...
                <div class="detail-seances">
                  <div class="detail-seance-dates-container">
                    <div v-for="(seance, index) in seance.dates.sort((a, b) => a.jourChiffre - b.jourChiffre)" :key="index" class="salle-detail-seance-dates" :class="{ 'selected': SelectedIndex === index }" @click="selectDate(index)">
                ...
                <div class = "movie-container">
                      <div class = "list-salles" v-if="SelectedIndex !== null">
                          <div v-for="(salles, sallesIndex) in seance.dates[SelectedIndex].films" class="seances-cinema-details" @click="openSeancesPage(salles.cinema)">
