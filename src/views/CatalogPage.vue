    ...
    <body>
        <header>
            <div class="headernav">
                ...
                <div class="Navbar">
                    <router-link to="/catalog-page" class="to-page-nav" :class="{ 'active-link': $route.path === '/catalog-page' }">Movie catalog</router-link>
                    <router-link to="/cinema" class="to-page-nav" :class="{ 'active-link': $route.path === '/cinema' }">Cinema</router-link>
                    <router-link to="/catalog-recs-page" class="to-page-nav" :class="{ 'active-link': $route.path === '/catalog-recs-page' }">Contacts</router-link>
            ...
            <div class="search-and-movie-container">
                ...
                <div class="search-container">
                    <div class="filter-search">
                        ...
                        <div class="search-bar-container" id="first-searchy-bar">
                            <input type="text" placeholder="Search.." v-model="searchBar" name="search" id="search-bar" @keyup.enter="getFilteredMoviesWithoutAPI()" >
                            <div  @click="getFilteredMoviesWithoutAPI()" ><font-awesome-icon icon="fa-solid fa-magnifying-glass" /></div>
                        </div>
                    </div>
                ...
                <div class="movie-counter-container">
                    ...
                    <div class="movie-catalog-container"  >
                        ...
                        <div v-for="(movie) in movies" @click = "OpenDetails(movie.titre, movie.genres, movie.synopsis, movie.duration, movie.date_sortie, movie.trailer, movie.langue, movie.age)">

                            <div class="movie">
                                <div>
                                    <img :src="'src/assets/Affiches/' + movie.image_src" alt="movie_pic" class="movie-cover">
                                </div>
                                    ...
                                    <div class="filters-list">
                                        <ul>
                                            <li class="filters-list-li">
                                                ...
                                                <div class="filters" >
                                                    <label class="task-container"  v-for = "genre in genre_list" :key = "genre" >{{ genre }}
                                                        <input type="checkbox" :value = genre   v-model="selectedGenres" @change="getFilteredMoviesWithoutAPI()"/>
                                            ...
                                            <li class="filters-list-li">
                                                ...
                                                <div class="filters">
                                                    <label class="task-container" v-for = "langue in langues_list" :key = "langue">{{langue}}
                                                        <input type="checkbox" :value = "langue" v-model="selectedLanguages" @change="getFilteredMoviesWithoutAPI()"/>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </li>
                                            ...
                                            <li class="filters-list-li">
                                                ...
                                                <div class="filters">
                                                    <label class="task-container" v-for="date in sortie_list" :key = "date">{{ date }}
                                                        <input type="checkbox" :value="date" v-model="selectedDuration" @change="getFilteredMoviesWithoutAPI()"/>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </li>
                        ...
                        <div class="modal-content2">
                            ...
                            <div class="details-block-container">
                                <div class="detail-block-header">
                                    ...
                                    <img :src="'src/assets/Details/' + SelectedMovie + '.jpg'" class="cover details-cover" />
                                    </div>
                                    ...
                                    <div class="details-container-info">
                                        <div class = "details-info">
                                            <div class="date-duration-langue">
                                                <p v-if="SelectedAge !== 'Tous Public'" class="detail-age"> -{{ SelectedAge }}</p>
                                                <p v-if="SelectedAge == 'Tous Public'" class="detail-age-tous"> {{ SelectedAge }}</p>
                                ...
                                <div class="detail-seance-container">
                                    ...
                                    <div class="detail-seance">
                                        <div class="detail-seance-dates-container">
                                            <div v-for="(seance, index) in getSelectedMovieSeances().dates" :key="index" class="detail-seance-dates" :class="{ 'selected': SelectedIndex === index }" @click="selectDate(index)">
                                        ...
                                        <div v-for="(cinema, cinemaIndex) in getSelectedMovieSeances().dates[SelectedIndex].cinemas" :key="cinemaIndex" class="cinema-details">
                                            <div class="cinema-info">
                                                <div class="cinema-name">{{ cinema.name }}</div>
                                                <div class="cinema-ville">{{ cinema.ville }}</div>
                                            </div>
                                            <div class="seances">
                                                <div v-for="(seance, seanceIndex) in cinema.seances" :key="seanceIndex" class="seance">
            ...
            <div class="content-footer">
                <div class="top">
                    <div class="logo-details">
                        <img alt="Vue logo" style="opacity: 0.7;" src="../assets/LogoJour1.png"
